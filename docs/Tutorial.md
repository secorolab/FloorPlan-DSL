...
![Frames available when modelling](../images/walls_with_frames.png){height=35%}
...
location:
    ...
    pose:
        ...
        rotation: 45.0 deg
```
![Pose of a space with regard to the world frame](../images/wall_location.png){height=35%}
...
![Pose of two spaces when walls are used as reference frames](../images/walls_with_frames_01.png){height=35%}
...
![Pose of two spaces when another wall is used as a reference frame](../images/walls_with_frames_02.png){height=35%}
...
![Two spaces not spaced correctly, as the `spaced` flag was not included](../images/walls_not_spaced.png){height=35%}
...
location:
    ...
    not aligned
```
![Two spaces not aligned as the `not aligned` flag was used](../images/walls_not_aligned.png){height=35%}
