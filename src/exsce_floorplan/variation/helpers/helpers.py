...
def shape_json(shape):
    ...
    context = {"type": shape.__class__.__name__}
...
def space_json(space):
    return {
        ...
        "location": {
            ...
            "to": {"index": space.location.to_frame.index},
...
def wall_opening_json(wall_opening):
    ...
    return {
        ...
        "in": {"wall_a": wall_opening.wall_a, "wall_b": wall_opening.wall_b},
...
def get_floorplan_as_json(flp_model):
    ...
    context = {
        ...
        "wall_openings": [
            wall_opening_json(wall_opening) for wall_opening in flp_model.wall_openings
        ],
